...
function CartItem({ product }) {
  ...
  return (
    <div className='bg-orange-900/30 py-2 my-2 rounded-lg '>
      <article className='bg-white/20 my-2 mx-1 px-2 sm:p-2 flex flex-row items-center justify-between rounded-lg '>
        ...
        <div className='flex flex-col justify-end items-center my-2 mx-1 mb-0 sm:m-auto ' >
          <div className='flex flex-row justify-between items-center w-20 rounded-md overflow-hidden my-1'>
            <button className=' border-r-2 border-orange-800 bg-orange-600/80 hover:bg-white/20  active:bg-slate-600  w-6 font-bold'
              onClick={() => handeDecrement({ id })} disabled={quantity === 1}>-</button>
            {quantity}
            <button className=' border-l-2 border-orange-800 bg-orange-600/80 hover:bg-white/20  active:bg-slate-600  w-6 font-bold'
      ...
      <button className='w-40 mx-4 text-xs font-semibold uppercase text-white hover:text-red-900 bg-white/20 rounded-md'
